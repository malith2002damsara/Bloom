...
const Hero = () => {
  return (
    <section className="bg-gradient-to-br from-pink-50 via-blue-50 to-green-50 py-8 md:py-12">
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
              Celebrate Your <span className="text-pink-500">Achievement</span> in Bloom
            </h1>
